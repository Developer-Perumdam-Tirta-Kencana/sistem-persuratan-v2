<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Undangan</h2>
                <p class="text-sm text-gray-500">Kelola undangan acara</p>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6 mb-6">
                <div class="flex items-center justify-between">
                    ...
                    <span class="inline-flex h-12 w-12 items-center justify-center rounded-full bg-pink-100 text-pink-600">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="px-6 py-12 text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-500">Mulai buat undangan acara Anda di sini.</p>
                    <div class="mt-6">
