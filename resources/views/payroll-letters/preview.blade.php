            ...
            <div class="bg-white shadow-sm sm:rounded-lg border border-gray-200">
                <div class="p-6">
                    ...
                    <div class="mt-6 inline-flex rounded-lg border border-gray-200 overflow-hidden">
                        <a href="{{ route('payroll-letters.previewFormat', [$payrollLetter, 'kop' => 1]) }}" class="px-4 py-2 text-sm font-medium transition border-r border-gray-200 {{ $withKop ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50' }}">Dengan Kop</a>
                        <a href="{{ route('payroll-letters.previewFormat', [$payrollLetter, 'kop' => 0]) }}" class="px-4 py-2 text-sm font-medium transition {{ !$withKop ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50' }}">Tanpa Kop</a>
                    </div>
