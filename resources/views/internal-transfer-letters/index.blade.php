    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                ...
                <p class="text-sm text-slate-600 mt-2">Kelola dan pantau semua surat pelimpahan rekening internal transfer</p>
            </div>
            <a href="{{ route('internal-transfer-letters.create') }}" class="inline-flex items-center px-6 py-2.5 bg-gradient-to-r from-red-600 to-red-700 text-white font-semibold hover:shadow-lg hover:from-red-700 hover:to-red-800 transition-all duration-200 transform hover:scale-105">
                    ...
                    <table id="internalTransferTable" class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            ...
                            <tr class="hover:bg-slate-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm text-slate-700">{{ $letter->no_rek_sumber }}</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm text-slate-700">{{ $letter->bank_tujuan }}</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm text-slate-700">{{ $letter->no_rek_tujuan }}</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12">
                                    <div class="text-center">
                                        ...
                                        <p class="text-slate-700 font-medium mb-2">Belum ada surat pelimpahan rekening</p>
                                        <p class="text-slate-600 text-sm mb-4">Mulai dengan membuat surat pertama Anda</p>
                                        <a href="{{ route('internal-transfer-letters.create') }}" class="inline-flex items-center px-4 py-2 bg-red-600 text-white font-semibold hover:bg-red-700 transition">
                                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
                                            Buat Surat Baru
                                        </a>
                                    </div>
