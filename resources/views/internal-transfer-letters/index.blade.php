                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <div class="flex justify-center gap-1.5 flex-wrap">
                                        ...
                                        <div class="inline-flex rounded-lg border border-gray-300 bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                                            <a href="{{ route('internal-transfer-letters.previewFormat', $letter) }}?kop=1" title="Lihat dengan kop (F4)" class="px-4 py-2 text-xs font-medium text-blue-600 hover:bg-blue-50 border-r border-gray-200 transition kop-button">📄 Lihat Dengan Kop</a>
                                            <a href="{{ route('internal-transfer-letters.previewFormat', $letter) }}?kop=0" title="Lihat tanpa kop" class="px-4 py-2 text-xs font-medium text-gray-600 hover:bg-gray-100 transition">📋 Lihat Tanpa Kop</a>
                                        </div>
