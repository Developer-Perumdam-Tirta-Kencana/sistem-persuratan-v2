...
<x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        {{ __('Edit Surat Pelimpahan Rekening') }}
    </h2>
</x-slot>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <form action="{{ route('internal-transfer-letters.update', $internalTransferLetter) }}" method="POST">
                    @csrf
                    @method('PUT')
                    
                    <div class="mb-4">
                        <label for="bank_sumber" class="block text-gray-700 text-sm font-bold mb-2">Bank Asal *</label>
                        <input type="text" name="bank_sumber" id="bank_sumber" value="{{ old('bank_sumber', $internalTransferLetter->bank_sumber) }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="no_rek_sumber" id="no_rek_sumber" value="{{ old('no_rek_sumber', $internalTransferLetter->no_rek_sumber) }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="nominal" id="nominal" value="{{ old('nominal', $internalTransferLetter->nominal) }}" min="0" step="0.01"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="bank_tujuan" id="bank_tujuan" value="{{ old('bank_tujuan', $internalTransferLetter->bank_tujuan) }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="no_rek_tujuan" id="no_rek_tujuan" value="{{ old('no_rek_tujuan', $internalTransferLetter->no_rek_tujuan) }}" 
