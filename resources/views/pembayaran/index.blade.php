    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500">Kelola transaksi pembayaran</p>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="px-6 py-12 text-center">
                    ...
                    <h3 class="mt-4 text-lg font-medium text-gray-900">Belum ada data pembayaran</h3>
                    <p class="mt-2 text-sm text-gray-500">Mulai catat transaksi pembayaran Anda di sini.</p>
                    <div class="mt-6">
