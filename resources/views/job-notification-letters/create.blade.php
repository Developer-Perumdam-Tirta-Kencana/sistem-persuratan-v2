...
<x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        {{ __('Tambah Surat Pemberitahuan Pekerjaan') }}
    </h2>
</x-slot>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <form action="{{ route('job-notification-letters.store') }}" method="POST">
                    @csrf
                    
                    <div class="mb-4">
                        <label for="instansi_tujuan" class="block text-gray-700 text-sm font-bold mb-2">Instansi Tujuan *</label>
                        <input type="text" name="instansi_tujuan" id="instansi_tujuan" value="{{ old('instansi_tujuan') }}" 
                            placeholder="Contoh: Dinas PU Bina Marga"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="jenis_pekerjaan" id="jenis_pekerjaan" value="{{ old('jenis_pekerjaan') }}" 
                            placeholder="Contoh: Perbaikan pipa bocor"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="lokasi_pekerjaan" id="lokasi_pekerjaan" rows="3" 
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('lokasi_pekerjaan') border-red-500 @enderror" required>{{ old('lokasi_pekerjaan') }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="hari_tanggal_pelaksanaan" id="hari_tanggal_pelaksanaan" value="{{ old('hari_tanggal_pelaksanaan') }}" 
