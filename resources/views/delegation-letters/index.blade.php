                    ...
                    <table id="delegationTable" class="w-full text-sm">
                        <thead>
                            <tr class="bg-slate-100 border-b border-slate-200 hover:bg-slate-200 transition-colors">
                                <th class="px-6 py-4 text-left font-bold text-slate-700 uppercase tracking-wider text-xs">Pemberi Kuasa 1</th>
                                <th class="px-6 py-4 text-left font-bold text-slate-700 uppercase tracking-wider text-xs">Pemberi Kuasa 2</th>
                                <th class="px-6 py-4 text-left font-bold text-slate-700 uppercase tracking-wider text-xs">Penerima Kuasa</th>
                                <th class="px-6 py-4 text-left font-bold text-slate-700 uppercase tracking-wider text-xs">Tujuan</th>
                            ...
                            <tr class="hover:bg-slate-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <div class="flex justify-center gap-1.5 flex-wrap">
                                        <!-- View Buttons -->
                                        <x-view-dropdown :route="route('delegation-letters.previewFormat', $letter)" :id="$letter->id" />
