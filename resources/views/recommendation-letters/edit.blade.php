    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <form action="{{ route('recommendation-letters.update', $recommendationLetter) }}" method="POST">
                    @csrf
                    @method('PUT')
                    
                    <div class="mb-4">
                        <label for="nama_pt" class="block text-gray-700 text-sm font-bold mb-2">Nama PT Pengembang *</label>
                        <input type="text" name="nama_pt" id="nama_pt" value="{{ old('nama_pt', $recommendationLetter->nama_pt) }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="jenis_kegiatan" id="jenis_kegiatan" value="{{ old('jenis_kegiatan', $recommendationLetter->jenis_kegiatan) }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_perumahan" id="nama_perumahan" value="{{ old('nama_perumahan', $recommendationLetter->nama_perumahan) }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="jumlah_unit" id="jumlah_unit" value="{{ old('jumlah_unit', $recommendationLetter->jumlah_unit) }}" min="1"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="lokasi" id="lokasi" rows="3" 
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('lokasi') border-red-500 @enderror" required>{{ old('lokasi', $recommendationLetter->lokasi) }}</textarea>
                        @error('lokasi')
                        <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                        @enderror
                    </div>
