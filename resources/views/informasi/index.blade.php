<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Informasi</h2>
                <p class="text-sm text-gray-500">Kelola informasi organisasi</p>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="px-6 py-12 text-center">
                    ...
                    <h3 class="mt-4 text-lg font-medium text-gray-900">Belum ada informasi</h3>
                    <p class="mt-2 text-sm text-gray-500">Mulai buat informasi pertama Anda untuk berbagi informasi dengan organisasi.</p>
                    <div class="mt-6">
