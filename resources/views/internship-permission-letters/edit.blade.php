    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <form action="{{ route('internship-permission-letters.update', $internshipPermissionLetter) }}" method="POST" 
                    x-data="{ mahasiswa: {{ json_encode(old('list_mahasiswa', $internshipPermissionLetter->list_mahasiswa)) }} }">
                    @csrf
                    @method('PUT')
                    
                    <div class="mb-4">
                        <label for="instansi_pendidikan" class="block text-gray-700 text-sm font-bold mb-2">Asal Kampus/Sekolah *</label>
                        <input type="text" name="instansi_pendidikan" id="instansi_pendidikan" value="{{ old('instansi_pendidikan', $internshipPermissionLetter->instansi_pendidikan) }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nomor_surat_permohonan" id="nomor_surat_permohonan" value="{{ old('nomor_surat_permohonan', $internshipPermissionLetter->nomor_surat_permohonan) }}" 
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="date" name="tanggal_mulai" id="tanggal_mulai" value="{{ old('tanggal_mulai', $internshipPermissionLetter->tanggal_mulai->format('Y-m-d')) }}" 
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_selesai" id="tanggal_selesai" value="{{ old('tanggal_selesai', $internshipPermissionLetter->tanggal_selesai->format('Y-m-d')) }}" 
