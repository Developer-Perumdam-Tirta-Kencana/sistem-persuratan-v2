            ...
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div class="mt-8 pt-6 border-t border-gray-200">
                    ...
                    <div class="bg-gray-50 rounded-lg overflow-hidden border border-gray-200">
                        <iframe src="{{ route('water-availability-letters.previewFormat', $waterAvailabilityLetter) }}" 
                ...
                <div class="mt-6 flex gap-2 flex-wrap">
                    <a href="{{ route('water-availability-letters.exportPdf', $waterAvailabilityLetter) }}" class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg transition">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        Download PDF
                    </a>
                    <a href="{{ route('water-availability-letters.exportDocx', $waterAvailabilityLetter) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition">
