...
<x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        {{ __('Edit Surat Informasi Ketersediaan Air') }}
    </h2>
</x-slot>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <form action="{{ route('water-availability-letters.update', $waterAvailabilityLetter) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex gap-4">
                            <label class="inline-flex items-center">
                                <input type="radio" name="status_ketersediaan" value="1" {{ old('status_ketersediaan', $waterAvailabilityLetter->status_ketersediaan) == '1' ? 'checked' : '' }} class="form-radio" required>
                                <span class="ml-2">Dapat Melayani</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="status_ketersediaan" value="0" {{ old('status_ketersediaan', $waterAvailabilityLetter->status_ketersediaan) == '0' ? 'checked' : '' }} class="form-radio" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_pengembang" id="nama_pengembang" value="{{ old('nama_pengembang', $waterAvailabilityLetter->nama_pengembang) }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_proyek" id="nama_proyek" value="{{ old('nama_proyek', $waterAvailabilityLetter->nama_proyek) }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="alamat_proyek" id="alamat_proyek" rows="3" 
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('alamat_proyek') border-red-500 @enderror" required>{{ old('alamat_proyek', $waterAvailabilityLetter->alamat_proyek) }}</textarea>
                        @error('alamat_proyek')
                        <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="nomor_surat_masuk" id="nomor_surat_masuk" value="{{ old('nomor_surat_masuk', $waterAvailabilityLetter->nomor_surat_masuk) }}" 
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_surat_masuk" id="tanggal_surat_masuk" value="{{ old('tanggal_surat_masuk', $waterAvailabilityLetter->tanggal_surat_masuk->format('Y-m-d')) }}" 
