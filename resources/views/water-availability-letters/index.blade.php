                    ...
                    <table id="waterAvailabilityTable" class="w-full text-sm">
                        <thead>
                            <tr class="bg-slate-100 border-b border-slate-200 hover:bg-slate-200 transition-colors">
                                ...
                                <th class="px-6 py-4 text-left font-bold text-slate-700 uppercase tracking-wider text-xs">Pengembang</th>
                                <th class="px-6 py-4 text-left font-bold text-slate-700 uppercase tracking-wider text-xs">Proyek</th>
                                <th class="px-6 py-4 text-left font-bold text-slate-700 uppercase tracking-wider text-xs">Nomor Surat</th>
                            ...
                            <tr class="hover:bg-slate-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <div class="flex justify-center gap-1.5 flex-wrap">
                                        <!-- View Buttons -->
                                        <x-view-dropdown :route="route('water-availability-letters.previewFormat', $letter)" :id="$letter->id" />
