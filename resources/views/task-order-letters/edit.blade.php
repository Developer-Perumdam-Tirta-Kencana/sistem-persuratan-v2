...
<x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        {{ __('Edit Surat Perintah Tugas (SPT)') }}
    </h2>
</x-slot>
                ...
                <form action="{{ route('task-order-letters.update', $taskOrderLetter) }}" method="POST" x-data="{ petugas: {{ json_encode(old('list_petugas', $taskOrderLetter->list_petugas)) }} }">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="dasar_surat" id="dasar_surat" rows="2" 
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('dasar_surat') border-red-500 @enderror" required>{{ old('dasar_surat', $taskOrderLetter->dasar_surat) }}</textarea>
                        @error('dasar_surat')
                        <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="hari_tanggal_tugas" id="hari_tanggal_tugas" value="{{ old('hari_tanggal_tugas', $taskOrderLetter->hari_tanggal_tugas) }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="waktu_tugas" id="waktu_tugas" value="{{ old('waktu_tugas', $taskOrderLetter->waktu_tugas) }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="tempat_tugas" id="tempat_tugas" value="{{ old('tempat_tugas', $taskOrderLetter->tempat_tugas) }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="keperluan_tugas" id="keperluan_tugas" rows="3" 
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('keperluan_tugas') border-red-500 @enderror" required>{{ old('keperluan_tugas', $taskOrderLetter->keperluan_tugas) }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="pakaian" id="pakaian" value="{{ old('pakaian', $taskOrderLetter->pakaian) }}" 
